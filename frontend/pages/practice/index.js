...
const PracticePage = () => {
  ...
  useEffect(() => {
    ...
    if (!authLoading) {
      if (!user) { // Nếu không có user (chưa đăng nhập), chuyển hướng
        // THAY ĐỔI: Hiển thị thông báo hoặc chuyển hướng
  ...
  // Nếu có lỗi (bao gồm lỗi chưa đăng nhập)
  if (error) {
    return (
    ...
    return (
      <div className="min-h-screen bg-gray-100 p-4 sm:p-6 lg:p-8 font-inter">
        <main className="max-w-6xl mx-auto bg-white rounded-xl shadow-lg p-6 sm:p-8 border border-gray-200 text-center">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-6">Hệ thống Bài tập Vật lý</h1>
          <p className="text-gray-700 text-lg mb-8">
            Khám phá các bài tập được phân loại theo chủ đề và độ khó, giúp bạn rèn luyện và nâng cao kỹ năng giải bài.
          </p>
          <div className="p-6 text-gray-600 bg-gray-50 rounded-lg shadow-inner">
